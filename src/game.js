...
var languageString = {
    "en-GB": {
        "translation": {
            ...
            "GAME_NAME" : "British Version", // Be sure to change this for your skill.
    ...
    "en-US": {
        "translation": {
            ...
            "GAME_NAME" : "Parent Educational Trivia Game", // Be sure to change this for your skill.
            "HELP_MESSAGE": "I will ask you %s multiple choice questions. Respond with the number of the answer. " +
            "For example, say one, two, three, or four. To start a new game at any time, say, start game. ",
            "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat. ",
            "ASK_MESSAGE_START": "Would you like to start playing?",
    ...
    "de-DE": {
        "translation": {
            ...
            "GAME_NAME" : "Deutsch", // Be sure to change this for your skill.
...
module.exports = {
    ...
    // handlers
    startStateHandlers: startStateHandlers,
    triviaStateHandlers: triviaStateHandlers,
    helpStateHandlers: helpStateHandlers,
    // helpers
    handleUserGuess: handleUserGuess,
    populateGameQuestions: populateGameQuestions,
    populateRoundAnswers: populateRoundAnswers,
    isAnswerSlotValid: isAnswerSlotValid
}
